...
public interface RequestHandler<T extends RadiusPacket, S extends SecretProvider> {
     ...
     */
    Promise<RadiusPacket> handlePacket(Channel channel, T request, InetSocketAddress remoteAddress, S secretProvider);
}
