...
public abstract class AccessRequest extends GenericRequest implements MessageAuthSupport<RadiusRequest> {
    ...
    protected static final int USER_NAME = RfcAttributeTypes.USER_NAME;
    protected static final int USER_PASSWORD = RfcAttributeTypes.USER_PASSWORD;
    protected static final int CHAP_PASSWORD = RfcAttributeTypes.CHAP_PASSWORD;
    protected static final int EAP_MESSAGE = RfcAttributeTypes.EAP_MESSAGE;
    protected static final int ARAP_PASSWORD = RfcAttributeTypes.ARAP_PASSWORD;
