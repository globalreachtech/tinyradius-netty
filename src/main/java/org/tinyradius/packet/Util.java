...
class Util {
    ...
    static byte[] xor(byte[] src1, int src1offset, int src1length,
        ...
        return xor(src1, src1offset, src1length, src2, src2offset, src2length, dst);
    }

    private static byte[] xor(byte[] src1, int src1offset, int src1length,
                              byte[] src2, int src2offset, int src2length, byte[] dst) {
