...
public class RadiusClient {
    ...
    /**
     * Sends an Access-Request packet and receives a clientResponse
     * packet.
     * @param request clientRequest packet
     * @return Radius clientResponse packet
     * @exception RadiusException malformed packet
     * @exception IOException communication error (after getRetryCount()
     * retries)
     */
    ...
    /**
     * Sends an Accounting-Request packet and receives a clientResponse
     * packet.
     * @param request clientRequest packet
     * @return Radius clientResponse packet
     * @exception RadiusException malformed packet
     ...
     * @return clientResponse Radius packet
     * @exception RadiusException malformed packet
     * @exception IOException communication error (after getRetryCount()
     * retries)
     */
     ...
     * @return received clientResponse packet
