...
class AttributesTest {
    ...
    void createAttributeKnownTypes() {
        final RadiusAttribute a1 = Attributes.create(dictionary, -1, 8, new byte[4]);
        ...
        final RadiusAttribute a3 = Attributes.create(dictionary, -1, 1, new byte[1]);
    ...
    void createAttributeUnknownTypes() {
        final RadiusAttribute a1 = Attributes.create(dictionary, -1, 255, new byte[5]);
