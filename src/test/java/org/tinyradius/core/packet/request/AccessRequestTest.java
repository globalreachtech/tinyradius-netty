...
class AccessRequestTest {
    ...
    void authenticatorOnlyAddedIfNull() throws RadiusPacketException {
        ...
        AccessRequestPap nullAuthRequest = (AccessRequestPap)
        ...
        RadiusRequest authRequest = ((AccessRequest) RadiusRequest.create(dictionary, ACCESS_REQUEST, (byte) 2, random.generateSeed(16), Collections.emptyList()))
                .withPapPassword(pw);
    ...
    void testDetectCorrectAuth() throws RadiusPacketException {
        ...
        byte[] encodedPw = random.generateSeed(16);

        AccessRequest papRequest = (AccessRequest) RadiusRequest.create(dictionary, ACCESS_REQUEST, (byte) 1, null,
        ...
        AccessRequest chapRequest = (AccessRequest) RadiusRequest.create(dictionary, ACCESS_REQUEST, (byte) 1, null,
        ...
        AccessRequest eapRequest = (AccessRequest) RadiusRequest.create(dictionary, ACCESS_REQUEST, (byte) 1, null,
        ...
        AccessRequest unknown = (AccessRequest) RadiusRequest.create(dictionary, ACCESS_REQUEST, (byte) 1, null, Collections.emptyList());
        assertInstanceOf(AccessRequestNoAuth.class, unknown);

        AccessRequest invalid = (AccessRequest) RadiusRequest.create(dictionary, ACCESS_REQUEST, (byte) 1, null,
                Arrays.asList(
    ...
    void withPasswordRemovesOtherTypes() throws RadiusPacketException {
        AccessRequestNoAuth accessRequest = (AccessRequestNoAuth) RadiusRequest.create(dictionary, ACCESS_REQUEST, (byte) 1, null, Collections.emptyList());

        // encode CHAP
        AccessRequestChap chap = (AccessRequestChap) accessRequest.withChapPassword("abc");
        ...
        // encode PAP
        AccessRequestPap pap = (AccessRequestPap) chap.withPapPassword("abc");
        ...
        // encode CHAP again
        AccessRequestChap chap2 = (AccessRequestChap) pap.withChapPassword("abc");
