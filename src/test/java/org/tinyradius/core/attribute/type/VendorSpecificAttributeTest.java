...
class VendorSpecificAttributeTest {
    ...
    void customTypeLengthToFromByteArray(int vendorId, int attribute1, int attribute2, int subAttrHeaderSize) {
        ...
        RadiusAttribute sub1 = vsa.getAttributes().getFirst();
        ...
        RadiusAttribute parsedSub1 = parsed.getAttributes().getFirst();
    ...
    void undistinguishedOctets() {
        ...
        AnonSubAttribute sub1 = (AnonSubAttribute) attribute1.getAttributes().getFirst();
        ...
        AnonSubAttribute sub2 = (AnonSubAttribute) attribute1.getAttributes().getFirst();
