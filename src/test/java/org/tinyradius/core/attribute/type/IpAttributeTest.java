...
class IpAttributeTest {
    ...
    void maxIpV4AsString() {
        ...
        final IpAttribute.V4 attribute = (IpAttribute.V4)
                IPV4.create(dictionary, -1, FRAMED_IP_ADDRESS, (byte) 0, maxValueStr);
    ...
    void ipV4BytesTooShort() {
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> IPV4.create(dictionary, -1, FRAMED_IP_ADDRESS, (byte) 0, new byte[2]));
    ...
    void ipV4BytesTooLong() {
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> IPV4.create(dictionary, -1, FRAMED_IP_ADDRESS, (byte) 0, new byte[5]));
    ...
    void ipV4AsString() {
        final IpAttribute.V4 attribute = (IpAttribute.V4)
                IPV4.create(dictionary, -1, FRAMED_IP_ADDRESS, (byte) 0, "192.168.0.1");
    ...
    void ipV4StringTooLong() {
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> IPV4.create(dictionary, -1, FRAMED_IP_ADDRESS, (byte) 0, "0.0.0.0.0"));
    ...
    void ipV4StringIsEmpty() {
        final RuntimeException exception = assertThrows(RuntimeException.class,
                () -> IPV4.create(dictionary, -1, FRAMED_IP_ADDRESS, (byte) 0, ""));
    ...
    void ipV6AsBytes() throws UnknownHostException {
        ...
        final IpAttribute.V6 attribute = (IpAttribute.V6)
                IPV6.create(dictionary, -1, NAS_IPV6_ADDRESS, (byte) 0, address.getAddress());
    ...
    void ipV6BytesTooShort() {
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> IPV6.create(dictionary, -1, NAS_IPV6_ADDRESS, (byte) 0, new byte[2]));
    ...
    void ipV6BytesTooLong() {
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> IPV6.create(dictionary, -1, NAS_IPV6_ADDRESS, (byte) 0, new byte[17]));
    ...
    void ipV6AsString() {
        final IpAttribute.V6 attribute = (IpAttribute.V6)
                IPV6.create(dictionary, -1, NAS_IPV6_ADDRESS, (byte) 0, "2001:0DB8:AC10:FE01:0000:0000:0000:0000");
        assertEquals("2001:db8:ac10:fe01:0:0:0:0", attribute.getValueString());
    }
    ...
    void ipV6StringTooLong() {
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> IPV6.create(dictionary, -1, NAS_IPV6_ADDRESS, (byte) 0, "20011:0DB8:AC10:FE01:0000:0000:0000:0000"));
        assertTrue(exception.getMessage().toLowerCase().contains("bad address"));
    }
    ...
    void ipV6StringTooShort() {
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> IPV6.create(dictionary, -1, NAS_IPV6_ADDRESS, (byte) 0, "2001:FE01:0000:0000:0000:0000"));
        assertTrue(exception.getMessage().toLowerCase().contains("bad address"));
    }
    ...
    void ipV6StringIsEmpty() {
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> IPV6.create(dictionary, -1, NAS_IPV6_ADDRESS, (byte) 0, ""));
        assertTrue(exception.getMessage().toLowerCase().contains("address can't be empty"));
    }
    ...
    void mismatchIpVersions() {
        final IllegalArgumentException v6Exception = assertThrows(IllegalArgumentException.class,
                () -> IPV6.create(dictionary, -1, NAS_IPV6_ADDRESS, (byte) 0, "192.168.0.1"));
        ...
        final IllegalArgumentException v4Exception = assertThrows(IllegalArgumentException.class,
                () -> IPV4.create(dictionary, -1, FRAMED_IP_ADDRESS, (byte) 0, "2001:4860:4860::8888"));
