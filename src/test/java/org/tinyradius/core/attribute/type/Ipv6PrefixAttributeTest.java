...
class Ipv6PrefixAttributeTest {
    ...
    void minAttributeLength() {
        ...
        final Ipv6PrefixAttribute prefixAttribute = (Ipv6PrefixAttribute)
                IPV6_PREFIX.create(dictionary, -1, FRAMED_IPV6_PREFIX, (byte) 0, new byte[2]);
        ...
        IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> IPV6_PREFIX.create(dictionary, -1, FRAMED_IPV6_PREFIX, (byte) 0, new byte[1]));
    ...
    void maxAttributeLength() {
        // max
        final Ipv6PrefixAttribute prefixAttribute = (Ipv6PrefixAttribute)
                IPV6_PREFIX.create(dictionary, -1, FRAMED_IPV6_PREFIX, (byte) 0, new byte[18]);
        assertEquals(18, prefixAttribute.getValue().length); // intentionally don't trim, avoid changing incoming data
        assertEquals("0:0:0:0:0:0:0:0/0", prefixAttribute.getValueString());

        // max+1
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> IPV6_PREFIX.create(dictionary, -1, FRAMED_IPV6_PREFIX, (byte) 0, new byte[20]));
        assertTrue(TestUtils.getStackTrace(exception).contains("should be 2-18 octets"));
    }
    ...
    void stringOk() {
        final Ipv6PrefixAttribute attribute = (Ipv6PrefixAttribute)
                IPV6_PREFIX.create(dictionary, -1, FRAMED_IPV6_PREFIX, (byte) 0, "2001:db8:ac10:fe01:0:0:0:0/64");
    ...
    void string60bitsOk() {
        final Ipv6PrefixAttribute attribute = (Ipv6PrefixAttribute)
                IPV6_PREFIX.create(dictionary, -1, FRAMED_IPV6_PREFIX, (byte) 0, "2001:0:0:1650:0:0:0:0/60");
    ...
    void stringEmpty() {
        final IllegalArgumentException exception = assertThrows(IllegalArgumentException.class,
                () -> IPV6_PREFIX.create(dictionary, -1, FRAMED_IPV6_PREFIX, (byte) 0, ""));
    ...
    void bitsOutsidePrefixLengthIsZero() {
        ...
        final IllegalArgumentException e1 = assertThrows(IllegalArgumentException.class,
                () -> IPV6_PREFIX.create(dictionary, -1, FRAMED_IPV6_PREFIX, (byte) 0, "fe80:fe80:fe80:fe80:fe80:fe80:fe80:fe80/64"));
        ...
        final IllegalArgumentException e2 = assertThrows(IllegalArgumentException.class,
                () -> IPV6_PREFIX.create(dictionary, -1, FRAMED_IPV6_PREFIX, (byte) 0, bytes));
    ...
    void validPrefixLessThan16Octets() {
        ...
        final RadiusAttribute attribute = IPV6_PREFIX.create(dictionary, -1, FRAMED_IPV6_PREFIX, (byte) 0, bytes);
