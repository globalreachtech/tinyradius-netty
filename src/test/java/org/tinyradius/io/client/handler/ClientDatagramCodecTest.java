...
class ClientDatagramCodecTest {
    ...
    void decodeSuccess() throws RadiusPacketException {
        ...
        RadiusResponse actual = (RadiusResponse) out1.getFirst();
    ...
    void encodeAccessRequest() throws RadiusPacketException {
        ...
        assertEquals(1, out1.size());
        AccessRequestPap sentAccessPacket = (AccessRequestPap) fromDatagram(dictionary, (DatagramPacket) out1.getFirst())
