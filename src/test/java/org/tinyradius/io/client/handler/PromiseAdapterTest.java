...
class PromiseAdapterTest {
    ...
    void encodeAppendProxyState() throws RadiusPacketException {
        ...
        RadiusRequest processedPacket1 = ((PendingRequestCtx) out1.getFirst()).getRequest();
        ...
        assertEquals(1, out1.size());
        RadiusRequest processedPacket2 = ((PendingRequestCtx) out2.getFirst()).getRequest();
    ...
    void encodeDecodeIdMismatch() throws RadiusPacketException {
        ...
        RadiusRequest preparedRequest = ((PendingRequestCtx) out.getFirst()).getRequest();
    ...
    void decodeAuthCheckFail() throws RadiusPacketException {
        ...
        assertEquals(1, out.size());
        RadiusRequest preparedRequest = ((RequestCtx) out.getFirst()).getRequest();
        byte[] requestProxyState = preparedRequest.getAttribute(PROXY_STATE).get().getValue();
    ...
    void encodeDecodeSuccess() throws RadiusPacketException {
        ...
        RadiusRequest encodedRequest = ((RequestCtx) out.getFirst()).getRequest();
